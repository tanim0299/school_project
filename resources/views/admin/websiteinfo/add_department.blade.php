	...
	<main class="main-content">
		<div class="container-fluid p-0">
			<div class="col-sm-12 col-12 bg-white p-0 p-4 border-bottom">
				<h3 class="font-weight-bold head"><img src="{{ url($setting->image) }}" class="img-fluid" style="height: 40px;">&nbsp;&nbsp;বিভাগ</h3>
			</div>
						...
						<form method="post" action="" class="btn-submit">
							<div class="row">
								...
								<div class="form-group col-md-12">
									...
									<input type="text" name="department_name" class="form-control" placeholder="Department Name" id="department_name" required="">
								</div>
