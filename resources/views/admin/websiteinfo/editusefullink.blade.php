...
<form method="POST" class="btn-submit" data-id="{{ $data->id }}">
  ...
  <div class="row">
    ...
    <div class="form-group col-md-12">
      <label>Title :</label>
      <input type="text" name="title" class="form-control" placeholder="Title" id="title" required="" value="{{ $data->title }}">
    </div>

    <div class="form-group col-md-12">
      <label>URL :</label>
      <input type="text" name="url" class="form-control" placeholder="URL" id="url" required="" value="{{ $data->url }}"> 
    </div>
