	...
	<main class="main-content">
		<div class="container-fluid p-0">
			<div class="col-sm-12 col-12 bg-white p-0 p-4 border-bottom">
				<h3 class="font-weight-bold head"><img src="{{ url($setting->image) }}" class="img-fluid" style="height: 40px;">&nbsp;&nbsp;পরীক্ষার সময়সূচী সংক্রান্ত তথ্য</h3>
			</div>
				...
				<div class="card mb-4 border-0">
					<div class="card-header">
						<div class="card-title">
							পরীক্ষার সময়সূচী সংক্রান্ত তথ্য
						</div>
					</div>
					<div class="card-body">
