	...
	<main class="main-content">
		<div class="container-fluid p-0">
			<div class="col-sm-12 col-12 bg-white p-0 p-4 border-bottom">
				<h3 class="font-weight-bold head"><img src="{{ url($setting->image) }}" class="img-fluid" style="height: 40px;">&nbsp;&nbsp;ছাত্র - ছাত্রী তথ্য চার্ট</h3>
			</div>
				...
				<div class="card mb-4 border-0">
					...
					<div class="card-body">
						<form method="post" action="{{ url('insertstudentinfochart') }}" enctype="multipart/form-data">
							...
							<button type="submit" class="btn btn-success btn-sm"><i class="fa fa-plus-square" aria-hidden="true"></i>&nbsp;&nbsp;Submit</button>
						</form>
					</div>
				</div>
			</div>
			...
			<div class="container-fluid mt-4">
				<div class="card mb-4 border-0">
					<div class="card-header">
						<div class="card-title">
							ছাত্র - ছাত্রী তথ্যসমূহের তালিকা
						</div>
					</div>
					<div class="card-body">
