	...
	<main class="main-content">
		<div class="container-fluid p-0">
			<div class="col-sm-12 col-12 bg-white p-0 p-4 border-bottom">
				<h3 class="font-weight-bold head"><img src="{{ url($setting->image) }}" class="img-fluid" style="height: 40px;">&nbsp;&nbsp;প্রধান শিক্ষক পরিচিতি</h3>
			</div>
			...
			<div class="container-fluid mt-4">
				<div class="card mb-4 border-0">
					...
					<div class="card-body">
						<form method="post" action="{{ url('principalintro_store/'.$view->id) }}" enctype="multipart/form-data">
							@csrf
