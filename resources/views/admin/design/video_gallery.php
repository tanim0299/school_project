	...
	<main class="main-content">
		<div class="container-fluid p-0">
			<div class="col-sm-12 col-12 bg-white p-0 p-4 border-bottom">
				<h3 class="font-weight-bold head"><img src="assets/img/logo.png" class="img-fluid" style="height: 40px;">&nbsp;&nbsp;Video Gallery</h3>
			</div>
					...
					<div class="card-body">
						...
						<table id="bs4-table" class="table table-bordered" cellspacing="0">
							...
							<tbody>
								<tr>
									<td>01</td>
									<td>Wifi Bill Wifi Bill Wifi Bill</td>
									<td>...</td>
									<td><iframe width="100%" height="150" src="https://www.youtube.com/embed/ZxEMQTAGYzI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></td>
									<td>
										<div class="dropdown ">
