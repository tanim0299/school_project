	...
	<main class="main-content">
		<div class="container-fluid p-0">
			<div class="col-sm-12 col-12 bg-white p-0 p-4 border-bottom">
				<h3 class="font-weight-bold head"><img src="assets/img/logo.png" class="img-fluid" style="height: 40px;">&nbsp;&nbsp;Principle Message</h3>
			</div>
						...
						<form method="post" action="">
							<div class="row">
								...
								<div class="form-group col-md-12">
									...
									<img src="assets/img/logo.png" class="img-fluid" style="height: 100px;">
								</div>
